...
namespace pallo\web\security\model;
...
class CachedSecurityModel implements SecurityModel {
     ...
     * @param pallo\library\filesystem\File $file The file to cache to
     * @return null
     */
     ...
     * @param pallo\library\filesystem\File $file The file to generate the code in
     * @return null
     */
     ...
     * @return pallo\library\filesystem\File The file to generate the code in
     * @return null
     */
    ...
    protected function generatePhp() {
        $output = "<?php\n\n";
        $output .= "/*\n";
        $output .= " * This file is generated by pallo\web\security\model\CachedSecurityModel.\n";
        $output .= " */\n";
        $output .= "\n";
